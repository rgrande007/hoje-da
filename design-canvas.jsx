...
function DesignCanvas({ children, minScale, maxScale, style }) {
  ...
  React.useEffect(() => {
    ...
    fetch('./' + DC_STATE_FILE)
      ...
      .catch((e) => { console.warn('[DesignCanvas] Failed to load state:', e); })
  ...
  React.useEffect(() => {
    ...
    const t = setTimeout(() => {
      window.omelette?.writeFile(DC_STATE_FILE, JSON.stringify({ sections: state.sections })).catch((e) => { console.warn('[DesignCanvas] Failed to save state:', e); });
    }, 250);
